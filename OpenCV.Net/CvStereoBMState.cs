...
namespace OpenCV.Net
{
    ...
    /// </summary>
    public class CvStereoBMState : SafeHandleZeroOrMinusOneIsInvalid
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CvStereoBMState"/> class with the specified
        ...
        /// </param>
        public CvStereoBMState(StereoBMPreset preset = StereoBMPreset.Basic, int numberOfDisparities = 0)
            : base(true)
        {
        ...
        /// <summary>
        /// Executes the code required to free the native <see cref="CvStereoBMState"/> handle.
        /// </summary>
        /// <returns>
