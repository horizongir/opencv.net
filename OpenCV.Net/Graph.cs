...
namespace OpenCV.Net
{
    ...
    public class Graph : Set
    {
        ...
        /// <summary>
        /// Gets the size of the <see cref="Graph"/> header, in bytes.
        /// </summary>
        ...
        /// </summary>
        /// <param name="storage">
        /// The destination <see cref="MemStorage"/> instance on which to store the new graph.
        /// If <paramref name="storage"/> is <b>null</b>, the same memory storage of this graph is used.
        /// </param>
        /// <returns>A new <see cref="Graph"/> instance that is a copy of this graph.</returns>
        public new Graph Clone(MemStorage storage = null)
        {
