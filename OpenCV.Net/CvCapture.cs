...
namespace OpenCV.Net
{
    ...
    public sealed class CvCapture : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        /// </param>
        /// <returns>
        /// A newly created <see cref="CvCapture"/> instance representing image
        ...
        /// acquisition from a camera.
        /// </returns>
        public static CvCapture CreateCameraCapture(int index, CaptureDomain domain)
        {
        ...
        /// <summary>
        /// Executes the code required to free the native <see cref="CvCapture"/> handle.
        /// </summary>
        /// <returns>
