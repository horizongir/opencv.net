...
namespace OpenCV.Net
{
    ...
    public struct CvMoments
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CvMoments"/> structure from the
        /// specified polygon or rasterized shape.
        /// </summary>
        /// <param name="arr">
        /// The handle to the polygon (CvSeq) or rasterized shape (IplImage) from which
        ...
        /// </summary>
        /// <returns>An instance of <see cref="CvHuMoments"/> containing the seven Hu moments.</returns>
