...
namespace OpenCV.Net
{
    ...
    /// </summary>
    public class CvFileNode : CvHandle
    {
        internal static readonly CvFileNode Null = new CvFileNode();
        ...
        /// <summary>
        /// Executes the code required to free the native <see cref="CvFileNode"/> handle.
        /// </summary>
        /// <returns>
