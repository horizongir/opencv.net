...
namespace OpenCV.Net
{
    ...
    /// </summary>
    public class CvSparseNode : CvHandle
    {
        CvSparseMat owner;

        internal CvSparseNode(IntPtr handle, CvSparseMat mat)
            : base(false)
        {
            SetHandle(handle);
            owner = mat;
        ...
        /// <summary>
        /// Executes the code required to free the native <see cref="CvSparseNode"/> handle.
        /// </summary>
        /// <returns>
