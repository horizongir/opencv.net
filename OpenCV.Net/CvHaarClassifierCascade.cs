...
namespace OpenCV.Net
{
    ...
    /// </summary>
    public class CvHaarClassifierCascade : CvHandle
    {
        internal CvHaarClassifierCascade(IntPtr handle)
            : base(true)
        {
            SetHandle(handle);
        }
        ...
        /// and is a temporary workaround to ensure <see cref="cv.Load(string,CvMemStorage,string)"/> does not throw
        /// an error.
        /// </summary>
        /// <param name="fileName">The path to the trained classifier cascade.</param>
        /// <returns>A new instance of the <see cref="CvHaarClassifierCascade"/> class.</returns>
        public static CvHaarClassifierCascade Load(string fileName)
        {
        ...
        public CvSeq DetectObjects(
            CvArr image,
            CvMemStorage storage,
            double scaleFactor = 1.1,
            int minNeighbors = 3,
            HaarDetectObjectFlags flags = HaarDetectObjectFlags.None,
            CvSize minSize = default(CvSize),
            CvSize maxSize = default(CvSize))
        {
        ...
        /// <summary>
        /// Executes the code required to free the native <see cref="CvHaarClassifierCascade"/> handle.
        /// </summary>
        /// <returns>
