...
namespace OpenCV.Net
{
    ...
    public class CvFileStorage : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        /// <see cref="GetFileNode(CvFileNode,CvStringHashNode,bool)"/> method.
        /// </returns>
        public CvStringHashNode GetHashedKey(string name, bool createMissing = false)
        {
        ...
        /// </returns>
        public CvFileNode GetRootFileNode(int streamIndex = 0)
        {
        ...
        public CvFileNode GetFileNode(CvFileNode map, CvStringHashNode key, bool createMissing = false)
        {
            var node = NativeMethods.cvGetFileNode(this, map ?? CvFileNode.Null, key ?? CvStringHashNode.Null, createMissing ? 1 : 0);
            return node.IsInvalid ? null : node;
        }
        ...
        public CvFileNode GetFileNode(CvFileNode map, string name)
        {
        ...
        public int ReadInt(CvFileNode node, int defaultValue = 0)
        {
        ...
        /// <returns>An integer that is represented by the file node.</returns>
        public int ReadInt(CvFileNode map, string name, int defaultValue = 0)
        {
        ...
        public double ReadReal(CvFileNode node, double defaultValue = 0)
        {
            if (node == null) return defaultValue;
        ...
        /// <param name="defaultValue">The value that is returned if the file node is not found.</param>
        /// <returns>A floating-point value that is represented by the file node.</returns>
        public double ReadReal(CvFileNode map, string name, double defaultValue = 0)
        {
        ...
        public string ReadString(CvFileNode node, string defaultValue = null)
        {
            if (node == null) return defaultValue;
        ...
        /// <param name="defaultValue">The value that is returned if the file node is not found.</param>
        /// <returns>A text string that is represented by the file node.</returns>
        public string ReadString(CvFileNode map, string name, string defaultValue = null)
        {
        ...
        public TElement Read<TElement>(CvFileNode node) where TElement : CvHandle
        {
        ...
        /// <param name="name">The node name.</param>
        /// <returns>The reference to the decoded object.</returns>
        public TElement Read<TElement>(CvFileNode map, string name) where TElement : CvHandle
        {
        ...
        /// <param name="format">Specification of each array element.</param>
        public void ReadRawData<TElement>(CvFileNode src, TElement[] dst, string format) where TElement : struct
        {
        ...
        /// <see cref="CvFileNode.Name"/> property.
        /// </param>
