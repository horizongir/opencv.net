...
namespace OpenCV.Net
{
    ...
    /// </summary>
    public class CvLatentSvmDetector : CvHandle
    {
        internal CvLatentSvmDetector()
            : base(true)
        {
        }
        ...
        /// <returns>A sequence of detected objects of type <see cref="CvObjectDetection"/>.</returns>
        ...
        /// <returns>A newly created instance of the <see cref="CvLatentSvmDetector"/> class.</returns>
        public static CvLatentSvmDetector Load(string fileName)
        {
            return NativeMethods.cvLoadLatentSvmDetector(fileName);
        }

        /// <summary>
        /// Executes the code required to free the native <see cref="CvLatentSvmDetector"/> handle.
        /// </summary>
        /// <returns>
