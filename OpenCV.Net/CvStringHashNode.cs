...
namespace OpenCV.Net
{
    ...
    /// </summary>
    public class CvStringHashNode : CvHandle
    {
        internal static readonly CvStringHashNode Null = new CvStringHashNode();

        internal CvStringHashNode()
            : base(false)
        {
        }

        internal CvStringHashNode(IntPtr handle)
            : base(false)
        {
            SetHandle(handle);
        }
        ...
        /// <summary>
        /// Executes the code required to free the native <see cref="CvStringHashNode"/> handle.
        /// </summary>
        /// <returns>
